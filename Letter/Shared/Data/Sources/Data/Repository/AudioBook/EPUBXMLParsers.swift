...
public final class EPUBContainerXMLParser: NSObject, XMLParserDelegate {
...
public final class EPUBPackageXMLParser: NSObject, XMLParserDelegate {
...
public final class EPUBNavigationXMLParser: NSObject, XMLParserDelegate {
    struct Link {
        let href: String
        let title: String
