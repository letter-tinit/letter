...
public protocol BudgetDetailUseCase {
...
public final class ImpBudgetDetailUseCase: BudgetDetailUseCase {
    ...
    public func addTransaction(_ input: ValidatedBudgetTransactionInput, to budget: Budget) throws {
    ...
    public func deleteTransaction(_ transaction: BudgetTransaction, from budget: Budget) throws {
    ...
    public func addFixedExpensePlan(_ input: ValidatedFixedExpensePlanInput, to budget: Budget) throws {
    ...
    public func deleteFixedExpensePlan(_ plan: FixedExpensePlan, from budget: Budget) throws {
...
private extension ImpBudgetDetailUseCase {
    public func allocation(id: UUID, in budget: Budget) throws -> BudgetAllocation {
