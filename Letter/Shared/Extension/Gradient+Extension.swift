...
extension Gradient {
    enum Glass {
        ...
        static let blue = Gradient(stops: [
        ...
        static let mint = Gradient(stops: [
        ...
        static let lavender = Gradient(stops: [
        ...
        static let beige = Gradient(stops: [
        ...
        static let gray = Gradient(stops: [
