...
enum BudgetAllocationInputMode: String, CaseIterable, Identifiable {
    case ratio
    case amount
...
struct CreateBudgetFormState: Equatable {
    ...
    var allocationInputMode: BudgetAllocationInputMode
    var allocationRatios: [BudgetRatioFormItem]
    ...
    func isAutoBalanced(_ kind: BudgetBucketKind) -> Bool {
...
private extension Array where Element == BudgetAllocation {
    func sortedByMethod(_ method: BudgetMethod) -> [BudgetAllocation] {
